...
INSERT INTO Users (name, housingKey, email, facebookID, isAdmin, verifiedEmail) VALUES ('Steve Johnson', 1, 'steve@asdf.asdf', '2weuhfdsu2j34f1d4', false, true);
INSERT INTO Users (name, housingKey, email, facebookID, isAdmin, verifiedEmail) VALUES ('Johnny Wang', 2, 'john@asdf.asdf', '12rehfdsu2j34f1d4', false, true);
SELECT * FROM Users;
