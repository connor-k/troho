	...
	<div class = "content">
		<div class = "container-fluid">
			...
			<div class = "row">
				...
				<div class = "col-lg-10">
				<% %>
				<a href="/troho/arush.jsp?name=Gateway">
					<div class = "col-lg-3"> 
					...
					<a href="/troho/arush.jsp?name=Icon Plaza">
					<div class = "col-lg-3"> 
						<div class = "house-card"></div>
					...
					<a href="/troho/arush.jsp?name=Cardinal Gardens">
					<div class = "col-lg-3"> 
						<div class = "house-card"></div>
					...
					<a href="/troho/arush.jsp?name=Trojan Hall">
					<div class = "col-lg-3"> 
						<div class = "house-card"></div>
